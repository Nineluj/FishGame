...
The format is as follows, each reworked step is separated into general data representation/task grouping, the number heading represents the order we implemented the change
...
In Game Tree, There can be more unit tests for first query function
